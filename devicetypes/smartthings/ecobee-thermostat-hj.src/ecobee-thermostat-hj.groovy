...
metadata {
	definition (name: "Ecobee Thermostat HJ", namespace: "smartthings", author: "Hoobajoob") {
		capability "Actuator"
	...
	simulator { }
        ...
        standardTile("currentProgramIcon", "device.currentProgramName", height: 2, width: 2, inactiveLabel: false, decoration: "flat") {
			...
			state "Home66", action:"noOp", label: 'Home66', icon: "https://raw.githubusercontent.com/StrykerSKS/SmartThings/master/smartapp-icons/ecobee/png/schedule_home_blue.png"
            ...
            state "Hold: Home66", action:"noOp", label: 'Hold: Home66', icon: "https://raw.githubusercontent.com/StrykerSKS/SmartThings/master/smartapp-icons/ecobee/png/schedule_home_blue.png"
        ...
        standardTile("setHome66", "device.setHome66", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
			state "home66", action:"home66", nextState: "updating", label:'Home66', icon:"https://raw.githubusercontent.com/StrykerSKS/SmartThings/master/smartapp-icons/ecobee/png/schedule_home_blue.png"
			state "updating", label:"Working...", icon: "st.samsung.da.oven_ic_send"
		}
		...
		details([
            ...
            "setHome", "setAway", "setSleep","setHome66",
...
def setThermostatProgramTemp(program, temp) {
	LOG("Setting Temperature of Program", 3)
    def deviceId = getDeviceId()
    if (parent.setProgramTemp(this, program, deviceId, temp)){
    	//LOG("Successfully set temp to ${temp}. Now setting program.", 4)
		//setThermostatProgram(program)
    }
    else{
    	LOG("Error setting temperature of ${program}.", 2, null, "warn")
    }
}
...
def home66() {
	// Change the Comfort Setting to Home
    LOG("home66()", 5)
    setThermostatProgramTemp("Home", 660)
}
